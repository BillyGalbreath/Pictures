package net.pl3x.bukkit.pictures.configuration;
...
public class Lang {
    ...
    public static String ERROR = "&cCould not download image";
    public static String IMAGE_CREATED = "&dImage created";

    private static void init() {
        COMMAND_NO_PERMISSION = getString("command-no-permission", COMMAND_NO_PERMISSION);
        ERROR = getString("error", ERROR);
        IMAGE_CREATED = getString("picture-created", IMAGE_CREATED);
    }
